...
export function RolesSection() {
  const roles = [
    { key: 'student', label: 'Student', color: '#059669', rgb: '5,150,105', headline: 'Real advice\nbefore you choose.', body: "Before you pick a college, a branch, a career — talk to someone who's already living it. Verified. Accountable. Real.", stats: ['Sessions from ₹19', 'Verified Insiders & Mentors', 'Same-day response', 'Instant booking & live QnA'], cta: 'Join as a Student', href: `${FRONTEND}/?role=student` },
    { key: 'insider', label: 'Insider', color: '#D97706', rgb: '217,119,6', headline: 'Your experience\nis worth money.', body: "You've navigated what thousands of students are figuring out. Your knowledge of college life, placements — it has real value.", stats: ['₹150–300 per session', 'Set your own pricing', 'Only 3–4 hrs/week work', 'Paid directly to UPI'], cta: 'Become a college Insider', href: `${FRONTEND}/?role=insider` },
...
export function WaitlistSection({ cd }) {
